...
export const GradeTable: FC = () => {
  const { data: grades, isLoading: isLoadingGrades, isError } = useGetGradeQuery({});
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <Button
          ...
          title="Edit"
          onClick={() => {
            router.push(`/grower/grades/${row.getValue('id')}`);
          }}
        >
    ...
    return (
      <div className="bg-white rounded-lg">
        <Alert variant="destructive">
          ...
          <AlertDescription>There was an error loading Grades, please try again later.</AlertDescription>
        </Alert>
      </div>
    );
  }
